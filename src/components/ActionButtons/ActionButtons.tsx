      ...
      <div className="action-button-wrapper">
        <button 
          ...
          className={`action-button 
            ${tg.colorScheme === 'light' && 'action-button-dark'}
            ${isPressed ? 'pressed' : ''} 
            ${isInCooldown && tg.colorScheme === 'dark' ? 'in-cooldown' : ''} 
            ${isInCooldown && tg.colorScheme === 'light' ? 'in-cooldown-dark' : ''}
            ${isAnimating ? 'complete-animation' : ''}`}
          onClick={handleClick}
